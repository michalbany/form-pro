        ...
        <li v-for="page in pageHierarchy.hierarchy" :key="page.id">
            ...
            <a @click.prevent="selectPage(page)"
                ...
                <div class="flex gap-1">
                    ...
                    <a @click.prevent="page.open = !page.open" v-if="page.subpages.length > 0"
                        class="transition cursor-pointer duration-150 ease-in-out hover:bg-gray-300 rounded-md">
                        <svg class="h-5 w-5 transition duration-150 ease-in-out" :class="{
                ...
                <div class="absolute flex gap-1 items-center right-1">
                    <a @click.prevent="deletePage(page)"
                    class="group h-full text-gray-400 cursor-pointer transition duration-150 ease-in-out hover:text-red-600">
                        <svg fill="currentColor" height="16" width="14" viewBox="0 0 448 512"><path d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"/></svg>
                        <p
                    ...
                    <a @click.prevent="createSubPage(page.id)"
            ...
            <PageSubpage v-if="page.subpages.length > 0" :subpages="page" @select="selectPage"
                @create-sub-page="createSubPage" @delete-page="deletePage"/>
        </li>
    </ul>
</template>
